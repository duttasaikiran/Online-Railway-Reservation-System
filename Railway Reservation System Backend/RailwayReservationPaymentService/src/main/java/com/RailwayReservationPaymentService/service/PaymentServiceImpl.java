...
public class PaymentServiceImpl implements PaymentService {
	...
	public void sendEmail(PaymentDetails payment) throws AddressException {
		final Email email = DefaultEmail.builder().from(new InternetAddress("aayushi1598@gmail.com"))
				.replyTo(new InternetAddress("aayushi1598@gmail.com"))
				.to(Lists.newArrayList(new InternetAddress("aayushi1598@gmail.com")))
